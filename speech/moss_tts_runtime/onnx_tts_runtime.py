...
class OnnxTtsRuntime(OrtCpuRuntime):
    ...
    def synthesize_single_chunk(
        ...
        *,
        ...
        generation_started_at_perf = time.perf_counter()
        ...
        def decode_pending_frames(force: bool) -> None:
            ...
            chunk = _merge_audio_channels([audio[0, channel_index, :audio_length] for channel_index in range(audio.shape[1])])
        ...
        return {
            ...
            "first_audio_seconds": (
                None
                if first_audio_emitted_at_perf is None
                else first_audio_emitted_at_perf - generation_started_at_perf
            ),
        }
