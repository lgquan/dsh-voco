/** Package invariant companion. @module @flowingspring/dsh-voice-assistant/invariant */
...
export const apply = (ctx: Context): Promise<() => void> => Promise.resolve(ctx.invariants.register('@flowingspring/dsh-voice-assistant', install))
